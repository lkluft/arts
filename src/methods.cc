    ...
    ( MdRecord
     ( NAME( "OptimizeDoitPressureGrid" ),
      ...
      OUT("p_grid", "pnd_field", "t_field", "scat_data_mono", "z_field", "cloudbox_limits",
          "doit_i_field_mono", "pha_mat_doit", "vmr_field", "p_grid_orig"),
      GOUT(),
      GOUT_TYPE(),
      GOUT_DESC(),
      IN( "p_grid", "pnd_field", "t_field", "scat_data_mono", "z_field", "cloudbox_limits",
         "doit_i_field_mono", "pha_mat_doit", "vmr_field", "f_grid", "f_index",
         "propmat_clearsky_agenda"),
    ...
    ( MdRecord
      ( NAME( "doit_scat_fieldCalc" ),
        ...
        IN( "doit_scat_field", "pha_mat_spt_agenda",
           ...
           "doit_za_grid_size","pha_mat_doit"
 ),
        GIN(),
        GIN_TYPE(),
        GIN_DEFAULT(),
    ...
    ( MdRecord
      ( NAME( "doit_scat_fieldCalcLimb" ),
        ...
        IN( "doit_scat_field", "pha_mat_spt_agenda",
            "doit_i_field_mono", "pnd_field", "t_field", "atmosphere_dim",
            "cloudbox_limits", "scat_za_grid", "scat_aa_grid",  
            "doit_za_grid_size", "doit_za_interp", "pha_mat_doit" ),
        GIN(),
        GIN_TYPE(),
        GIN_DEFAULT(),
        GIN_DESC()
    ...
    ( MdRecord
      ...
      ( NAME( "iyCalc" ),
        ...
        IN( "atmgeom_checked", "atmfields_checked", 
            "iy_aux_vars", "iy_id", "f_grid", "t_field", 
    ...
    ( MdRecord
      ( NAME( "iyFOS" ),
        ...
        IN( "diy_dx", "stokes_dim", "f_grid", "atmosphere_dim",
            ...
            "pnd_field", "use_mean_scat_data", "scat_data", "scat_data_checked",
    ...
    ( MdRecord
      ( NAME( "MCGeneral" ),
        ...
        IN( "mc_antenna", "f_grid", "f_index", "sensor_pos", "sensor_los", 
            ...
            "ppath_lmax", "ppath_lraytrace", "iy_space_agenda", "surface_rtprop_agenda", 
    ...
    ( MdRecord
      ( NAME( "pnd_fieldCalcFromParticleBulkProps" ),
        ...
        IN( "atmosphere_dim", "p_grid", "lat_grid", "lon_grid", "t_field",
            "cloudbox_on", "cloudbox_limits", "scat_species", "scat_data",
            "scat_meta", "particle_bulkprop_field", "particle_bulkprop_names",
    ...
    ( MdRecord
      ( NAME( "ppathFromRtePos2" ),
        ...
        IN( "ppath_step_agenda", "atmosphere_dim", "p_grid", 
            ...
            "rte_pos", "rte_pos2", "rte_los", "ppath_lmax", "ppath_lraytrace" ),
    ...
    ( MdRecord
      ( NAME( "ppathStepByStep" ),
        ...
        IN( "ppath_step_agenda", "ppath_inside_cloudbox_do", "atmosphere_dim", 
            "p_grid", "lat_grid", "lon_grid", "t_field", "z_field", "vmr_field",
            "f_grid", "refellipsoid", "z_surface", 
            "cloudbox_on", "cloudbox_limits", "rte_pos", "rte_los", "ppath_lmax",
            "ppath_lraytrace" ),
        GIN(),
        GIN_TYPE(),
        GIN_DEFAULT(),
  ...
  md_data_raw.push_back
    ( MdRecord
      ( NAME( "ScatElementsToabs_speciesAdd" ),
        ...
        GOUT_TYPE(),
        GOUT_DESC(),
        IN( "scat_data_raw", "vmr_field_raw", "abs_species",
            "propmat_clearsky_agenda_checked", "abs_xsec_agenda_checked",
